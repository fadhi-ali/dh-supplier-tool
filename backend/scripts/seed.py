...
async def seed():
    ...
    async with async_session() as db:
        ...
        s1 = Supplier(
            ...
            tax_id="12-3456789",
            npi="1234567890",
            operations_contact_name="Sarah Johnson",
            operations_contact_email="sarah@medequippro.com",
            operations_contact_phone="(512) 555-0101",
        ...
        s2 = Supplier(
            ...
            tax_id="98-7654321",
            npi="0987654321",
            operations_contact_name="Emily Rivera",
            operations_contact_email="emily@homehealthsupplies.com",
            operations_contact_phone="(303) 555-0201",
        ...
        s3 = Supplier(
            ...
            operations_contact_name="Alex Kim",
            operations_contact_email="alex@newdme.com",
            current_step=2,
            status=SupplierStatus.in_progress,
        )
        db.add(s3)
